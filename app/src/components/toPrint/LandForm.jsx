...
const LandPrintForm = () => {
    return (
        <section className="max-h-full m-5">
            ...
            <section className="flex justify-start items-center mt-3">
                <h2 className="text-2xl whitespace-nowrap">Obecny właściciel:</h2>
                <p className="text-2xl">....................................................................................................</p>
            </section>
            <section className="flex justify-start items-center mt-3">
            ...
            <section className="flex flex-col justify-center items-center mt-3 mx-5">
